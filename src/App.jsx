...
function App() {
  ...
  return (
    <>
      <div className="flex  dark:bg-gray-900 justify-center w-full h-screen items-center">
        <section class="bg-white dark:bg-gray-900">
          <div class="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-16 lg:px-12">
            ...
            <p class="font-light text-gray-500 md:text-lg xl:text-xl dark:text-gray-400">The server part is mostly done. You can try it out using Postman.</p>
            <p class="font-light text-gray-500 mt-5 md:text-lg xl:text-xl text-end dark:text-gray-400">:- by Harshit Gupta</p>
          </div>
        </section>
      </div>
    </>
